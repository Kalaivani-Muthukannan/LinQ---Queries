...
namespace ExcersiceLinq
{
    ...
    public class TraineeData
    {
        public List<TraineeDetails> GetTraineeDetails()
        {
            ...
            {
                new TraineeDetails { TraineeId ="SF2001" , TraineeName = "Dinesh" , DOJ ="16/07/2019" , YearPassedOut = 2019,
                ...
                new TraineeDetails { TraineeId ="SF2002" , TraineeName = "Deepa" , DOJ ="17/08/2019" , YearPassedOut = 2019,
                                     ScoreDetails = new List<TraineeScore>
                                     {
